import { IERC721Metadata } from '../../../../typechain-types/@openzeppelin/contracts/token/ERC721/extensions/IERC721Metadata';
import { useState, useEffect } from 'react';
import { PokemonNFT, Auction } from './types';
...
const contractAddressPokemon="0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0";
const contractAddressAuction="0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9";
    ...
    try{
        ...
        if(mintedTokenId!==null){
            ...
            if (!tokenURI.startsWith(base64Prefix)) {
                ...
                const base64String=tokenURI.substring(base64Prefix);
                let jsonString;
